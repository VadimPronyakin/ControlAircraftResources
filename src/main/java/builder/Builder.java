...
public class Builder {
    ...
    public static void createEngine(TextField[] fields) {
        ...
        log.info("Создали новый двигатель {} \n" +
                        ...
                        "остаток ресурса до 10-ти часовых работ {} \n" +
                        "остаток ресурса до 25-ти часовых работ {} \n" +
                        "остаток ресурса до 50-ти часовых работ {} \n" +
                        "остаток ресурса до 100-ти часовых работ {} \n" +
                        "остаток ресурса до 150-ти часовых работ {} \n" +
                        "остаток ресурса до замены масла {} \n" +
                        "остаток ресурса до 278-го бюллетеня {}", engine,
